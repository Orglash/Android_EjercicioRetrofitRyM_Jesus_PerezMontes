...
public class RyMAdapter extends RecyclerView.Adapter<RyMAdapter.CharacterViewHolder> {
    ...
    public RyMAdapter(Context context, List<Character> characters, CustomItemClick customItemclick){
